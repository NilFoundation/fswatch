...
namespace fsw {
    libfsw_exception::libfsw_exception(string cause, int code) : cause(std::move(cause)), code(code) {
    }
    ...
    libfsw_exception::libfsw_exception(const libfsw_exception &other) noexcept : cause(other.cause), code(other.code) {
    }
