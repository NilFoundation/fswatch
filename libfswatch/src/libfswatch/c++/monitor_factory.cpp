...
namespace fsw {
    static monitor *
        create_default_monitor(std::vector<std::string> paths, FSW_EVENT_CALLBACK *callback, void *context) {
        ...
        return monitor_factory::create_monitor(type, std::move(paths), callback, context);
    }
