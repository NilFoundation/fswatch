 ...
 */
#ifdef HAVE_CONFIG_H
#include <libfswatch/c++/libfswatch_config.h>
#endif
...
namespace fsw {
    ...
    poll_monitor::poll_monitor(vector<string> paths, FSW_EVENT_CALLBACK *callback, void *context) :
    ...
    bool poll_monitor::initial_scan_callback(const string &path, const struct stat &stat) {
    ...
    bool poll_monitor::intermediate_scan_callback(const string &path, const struct stat &stat) {
